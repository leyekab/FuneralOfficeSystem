    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuneralOffices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Funerals_FuneralOffices_FuneralOfficeId",
                        column: x => x.FuneralOfficeId,
                        principalTable: "FuneralOffices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuneralProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FuneralProducts_Funerals_FuneralId",
                        column: x => x.FuneralId,
                        principalTable: "Funerals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FuneralProducts_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_FuneralOffices_FuneralOfficeId",
                        column: x => x.FuneralOfficeId,
                        principalTable: "FuneralOffices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_FuneralOffices_DestinationFuneralOfficeId",
                        column: x => x.DestinationFuneralOfficeId,
                        principalTable: "FuneralOffices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_FuneralOffices_SourceFuneralOfficeId",
                        column: x => x.SourceFuneralOfficeId,
                        principalTable: "FuneralOffices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FuneralServices_Funerals_FuneralId",
                        column: x => x.FuneralId,
                        principalTable: "Funerals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FuneralServices_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuneralProducts_FuneralId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Funerals_FuneralOfficeId",
                table: "Funerals",
                column: "FuneralOfficeId");

            migrationBuilder.CreateIndex(
                name: "IX_FuneralServices_FuneralId",
                table: "FuneralServices",
                column: "FuneralId");

            migrationBuilder.CreateIndex(
                name: "IX_FuneralServices_ServiceId",
                table: "FuneralServices",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_FuneralOfficeId",
                table: "Inventories",
                column: "FuneralOfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_DestinationFuneralOfficeId",
                table: "InventoryTransactions",
                column: "DestinationFuneralOfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_SourceFuneralOfficeId",
                table: "InventoryTransactions",
                column: "SourceFuneralOfficeId");
