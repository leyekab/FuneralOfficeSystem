...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.CategoryProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ProductProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ServiceCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ServiceCategoryProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ServiceProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.CategoryProperty", b =>
                {
                    b.HasOne("FuneralOfficeSystem.Models.ProductCategory", "Category")
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ProductCategory", b =>
                {
                    b.HasOne("FuneralOfficeSystem.Models.ProductCategory", "ParentCategory")
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ProductProperty", b =>
                {
                    b.HasOne("FuneralOfficeSystem.Models.CategoryProperty", "CategoryProperty")
                        .WithMany()
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.Service", b =>
                {
                    b.HasOne("FuneralOfficeSystem.Models.ServiceCategory", "Category")
                        .WithMany("Services")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ServiceCategory", b =>
                {
                    b.HasOne("FuneralOfficeSystem.Models.ServiceCategory", "ParentCategory")
                        .WithMany("SubCategories")
                        .HasForeignKey("ParentCategoryId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FuneralOfficeSystem.Models.ServiceProperty", b =>
                {
                    b.HasOne("FuneralOfficeSystem.Models.ServiceCategoryProperty", "CategoryProperty")
                        .WithMany()
                        .HasForeignKey("CategoryPropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
